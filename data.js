...
const CLAIMS_DATA = {
  ...
  mediosProbatorios: [
    // 1. Facturación y Cobro (materiaId: 1)
    { id: 1, concepto: "Desacuerdo con el cálculo de los consumos facturados", materiaId: 1, servicios: ["Telefonía Fija", "LDI-Fija", "LDN"], medios: ["Boleta de consumos por cobro revertido", "Detalle de consumo", "Histórico de cortes y reactivaciones", "Informe de investigación de llamadas", "Inspección técnica", "Promedio de consumo", "Recibo", "Registro de problemas de calidad y averías"] },
    { id: 2, concepto: "Desacuerdo con el cálculo de los consumos facturados", materiaId: 1, servicios: ["Servicio Móvil Postpago", "Internet Móvil", "LDI-Servicio Móvil", "LDN"], medios: ["Boleta de consumos por cobro revertido", "Detalle de consumos", "Detalle desagregado, valorizado y totalizado por cada modalidad o tipo de consumo del periodo reclamado", "Histórico de cortes y reactivaciones", "Registro de problemas de calidad y averías", "Recibo", "Informe de investigación de llamadas"] },
    { id: 3, concepto: "Desacuerdo con la tarifa aplicada de consumos adicionales facturados", materiaId: 1, servicios: ["Telefonía Fija", "Servicio Móvil Postpago", "Internet Móvil", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Histórico de pedidos", "Mecanismo de contratación", "Recibo"] },
    { id: 4, concepto: "Desacuerdo con el cargo por reconexión", materiaId: 1, servicios: ["Telefonía Fija", "Televisión de Paga", "Internet de Acceso Fijo", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Constancia de pago", "Histórico de cortes y reactivaciones", "Histórico de estado de cuenta", "Histórico de reclamos", "Informe de recaudación de pagos", "Recibo"] },
    { id: 5, concepto: "Desacuerdo con otro monto correspondiente a cualquier concepto facturado en el recibo cuyo consumo se desconoce", materiaId: 1, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Acuerdo de financiamiento de deuda", "Recibo"] },
    { id: 6, concepto: "Pagos no procesados o registrados", materiaId: 1, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Constancia de pago", "Histórico de estado de cuenta", "Informe de recaudación de pagos"] },
    { id: 7, concepto: "Cobro de montos no facturados oportunamente o realizados por documentos distinto al recibo", materiaId: 1, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Histórico de estado de cuenta", "Recibo"] },
    { id: 8, concepto: "Cobros de equipos terminales incluido en el recibo por desacuerdo en el monto facturado o por reintegro del descuento de equipos terminales vinculados a la permanencia del servicio público de telecomunicaciones contratado", materiaId: 1, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Acuerdo para la adquisición o financiamiento de equipos terminales", "Constancia de entrega de equipo o sim card", "Recibo"] },
    { id: 9, concepto: "Cobros de equipos terminales incluido en el recibo por desacuerdo en el monto facturado o por reintegro del descuento de equipos terminales vinculados a la permanencia del servicio público de telecomunicaciones contratado", materiaId: 1, servicios: ["Servicio Móvil Postpago"], medios: ["Acuerdo para la adquisición de equipo terminal con descuento", "Cálculo de reintegro de precio de equipo", "Constancia de entrega de equipo o sim card", "Recibo"] },

    // 2. Calidad o Idonedidad en la Prestación del Servicio (materiaId: 2)
    { id: 10, concepto: "Calidad o Idonedidad en la Prestación del Servicio", materiaId: 2, servicios: ["Servicio Móvil Postpago", "Servicio Móvil Prepago", "Internet Móvil"], medios: ["Constancia de conformidad a la solución del problema de calidad o avería", "Detalle de consumos", "Informe de atención de los problemas de calidad y avería", "Registro de información de llamadas entrantes", "Registro de problemas de calidad y averías"] },
    { id: 11, concepto: "Calidad o Idonedidad en la Prestación del Servicio", materiaId: 2, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Constancia de conformidad a la solución del problema de calidad o avería", "Constancia de primera visita de atención de reporte por problemas de calidad o avería de servicios fijos", "Detalle de consumos", "Inspección técnica", "Informe de atención de los problemas de calidad y avería", "Registro de información de llamadas entrantes", "Registro de problemas de calidad y averías"] },
    { id: 12, concepto: "Calidad o Idonedidad en la Prestación del Servicio", materiaId: 2, servicios: ["Internet de Acceso Fijo", "Internet Móvil"], medios: ["Constancia de conformidad a la solución del problema de calidad o avería", "Constancia de medición de velocidad del servicio de Internet", "Diagrama de tráfico (Traffic View)", "Informe de atención de los problemas de calidad y avería", "Registro de problemas de calidad y averías"] },

    // 3. Incumplimiento de Condiciones Contractuales, Ofertas y Promociones (materiaId: 3)
    { id: 13, concepto: "Incumplimiento de la aplicación de condiciones y tarifas del plan contratado distintas a las pactadas en el contrato, salvo que se refieran a modificaciones contractuales más beneficiosas o incremento tarifario", materiaId: 3, servicios: ["Todos los servicios"], medios: ["Constancia de asignación de saldo", "Mecanismo de contratación", "Recibo"] },
    { id: 14, concepto: "Incumplimiento de la aplicación de condiciones y tarifas del plan contratado distintas a las pactadas en el contrato, salvo que se refieran a modificaciones contractuales más beneficiosas o incremento tarifario", materiaId: 3, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Constancia de haber informado al abonado sobre el incremento tarifario", "Recibo"] },
    { id: 15, concepto: "Descuentos no reconocidos de los atributos y/o beneficios del plan contratado, oferta y/o promoción", materiaId: 3, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Detalle desagregado, valorizado y totalizado por cada modalidad o tipo de consumo del periodo reclamado", "Registro de problemas de calidad y averías", "Histórico de cortes y reactivaciones"] },
    { id: 16, concepto: "Omisión de información o información inexacta sobre cobertura u otras características o limitaciones del servicio", materiaId: 3, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Servicio Móvil Prepago", "Internet Móvil"], medios: ["Constancia de publicación de información de cobertura", "Mecanismo de contratación"] },
    { id: 17, concepto: "Omisión de información o información inexacta sobre cobertura u otras características o limitaciones del servicio", materiaId: 3, servicios: ["Todos los servicios"], medios: ["Mecanismo de contratación"] },
    { id: 18, concepto: "Incumplimiento de ofertas o promociones ofrecidas y/o contratadas", materiaId: 3, servicios: ["Todos los servicios"], medios: ["Constancia de asignación de saldo", "Histórico de pedidos", "Mecanismo de contratación"] },

    // 4. Falta de Servicio (materiaId: 4)
    { id: 19, concepto: "Interrupción, suspensión, corte o baja injustificada del servicio o sin observar el procedimiento establecido en la normativa vigente", materiaId: 4, servicios: ["Todos los servicios"], medios: ["Detalle de consumos", "Histórico de cortes y reactivaciones", "Recibo", "Registro de problemas de calidad y averías"] },
    { id: 20, concepto: "Interrupción, suspensión, corte o baja injustificada del servicio o sin observar el procedimiento establecido en la normativa vigente", materiaId: 4, servicios: ["Todos los servicios"], medios: ["Histórico de cortes y reactivaciones", "Histórico de estado de cuenta", "Histórico de reclamos", "Constancia de pago"] },
    { id: 21, concepto: "Interrupción, suspensión, corte o baja injustificada del servicio o sin observar el procedimiento establecido en la normativa vigente", materiaId: 4, servicios: ["Todos los servicios"], medios: ["Mecanismo de contratación (solicitud de baja)", "Histórico de Peticiones"] },
    { id: 22, concepto: "Interrupción, suspensión, corte o baja injustificada del servicio o sin observar el procedimiento establecido en la normativa vigente", materiaId: 4, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Constancia de pago", "Constancia de comunicación al abonado de la fecha en que será ejecutado el corte y baja del servicio por falta de pago", "Consulta del estado del servicio", "Histórico de cortes y reactivaciones", "Histórico de estado de cuenta"] },
    { id: 23, concepto: "Interrupción, suspensión, corte o baja injustificada del servicio o sin observar el procedimiento establecido en la normativa vigente", materiaId: 4, servicios: ["Servicio Móvil Prepago"], medios: ["Constancia de comunicación al abonado de la baja del servicio contratado bajo la modalidad prepago", "Consulta del estado del servicio"] },
    { id: 24, concepto: "Suspensión del servicio por uso prohibido en establecimientos penitenciarios", materiaId: 4, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Constancia de haber realizado el corte conforme lo dispuesto en las normas de uso prohibido", "Histórico de cortes y reactivaciones", "Informe de investigación de llamadas", "Reporte de CDR (Call Detail Register)"] },
    { id: 25, concepto: "Falta de reactivación del servicio pese al pago del recibo", materiaId: 4, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Constancia de pago", "Histórico de cortes y reactivaciones", "Histórico de estado de cuenta"] },
    { id: 26, concepto: "Cambio de titularidad del servicio o reposición de SIM CARD sin consentimiento del abonado", materiaId: 4, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Internet Móvil", "Televisión de Paga"], medios: ["Histórico de cambio de titularidad del servicio", "Mecanismo de contratación (solicitud de cambio de titularidad)"] },
    { id: 27, concepto: "Cambio de titularidad del servicio o reposición de SIM CARD sin consentimiento del abonado", materiaId: 4, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Constancia de validación de código como confirmación del consentimiento del abonado para realizar la portabilidad o para la cesión de posición contractual", "Histórico de cambio de titularidad del servicio", "Mecanismo de contratación (solicitud de cambio de titularidad)", "Reporte de verificación biométrica de huella dactilar"] },
    { id: 28, concepto: "Cambio de titularidad del servicio o reposición de SIM CARD sin consentimiento del abonado", materiaId: 4, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Mecanismo de contratación (solicitud de reposición de SIM card)", "Reporte de verificación biométrica de huella dactilar"] },

    // 5. Instalación, Activación o Traslado del Servicio (materiaId: 5)
    { id: 29, concepto: "Falta de instalación del servicio fijo", materiaId: 5, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Constancia de instalación del servicio", "Recibo"] },
    { id: 30, concepto: "Falta de activación del servicio móvil", materiaId: 5, servicios: ["Servicio Móvil Postpago", "Servicio Móvil Prepago", "Internet Móvil"], medios: ["Consulta del estado del servicio", "Recibo"] },
    { id: 31, concepto: "Falta de traslado del servicio", materiaId: 5, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Constancia de haber presentado una solicitud determinada", "Constancia de instalación del servicio", "Histórico de pedidos", "Recibo"] },
    { id: 32, concepto: "Falta de respuesta a la solicitud de trasladado o negativa a la misma", materiaId: 5, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Constancia de haber presentado una solicitud determinada", "Constancia donde se informa la imposibilidad de realizar el traslado del servicio", "Histórico de pedidos"] },
    { id: 33, concepto: "Falta de devolución de los montos cobrados por instalación, activación o traslado no ejecutados", materiaId: 5, servicios: ["Todos los servicios"], medios: ["Constancia de devoluciones por pagos indebidos o en exceso", "Histórico de estado de cuenta"] },

    // 6. Falta de Ejecución de Baja o Suspensión del Servicio (materiaId: 6)
    { id: 34, concepto: "Falta de ejecución de la baja", materiaId: 6, servicios: ["Todos los servicios"], medios: ["Constancia de haber presentado una solicitud determinada", "Histórico de pedidos", "Consulta del estado del servicio"] },
    { id: 35, concepto: "Falta de ejecución de la suspensión temporal del servicio", materiaId: 6, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "LDI-Fija", "LDI-Servicio Móvil", "LDN"], medios: ["Constancia de haber presentado una solicitud determinada", "Histórico de pedidos", "Recibo"] },
    { id: 36, concepto: "Falta de ejecución de la suspensión temporal del servicio", materiaId: 6, servicios: ["Servicio Móvil Postpago", "Internet Móvil"], medios: ["Constancia de haber presentado una solicitud determinada", "Constancia de ingreso o salida del equipo al servicio técnico", "Histórico de pedidos", "Recibo"] },
    { id: 50, concepto: "Montos cobrados posteriores a la fecha en que se efectuó la baja o correspondía efectuarla", materiaId: 6, servicios: ["Todos los servicios"], medios: ["Constancia de haber presentado una solicitud determinada", "Histórico de pedidos", "Consulta del estado del servicio"] },
    { id: 51, concepto: "Montos cobrados posteriores a la fecha en que se efectuó la suspensión temporal o correspondía efectuarla", materiaId: 6, servicios: ["Todos los servicios"], medios: ["Constancia de haber presentado una solicitud determinada", "Histórico de pedidos", "Recibo"] },

    // 7. Recargas (materiaId: 7)
    { id: 37, concepto: "Falta de asignación de saldo o atributos", materiaId: 7, servicios: ["Todos los servicios"], medios: ["Constancia de asignación de saldo", "Detalle de consumos", "Histórico de recargas"] },
    { id: 52, concepto: "Descuentos indebidos de los saldos o del crédito", materiaId: 7, servicios: ["Todos los servicios"], medios: ["Constancia de asignación de saldo", "Detalle de consumos", "Histórico de recargas"] },
    { id: 53, concepto: "Afiliación a paquetes de adquisición de tráfico u otros promocionales no solicitados que impliquen un descuento del saldo", materiaId: 7, servicios: ["Todos los servicios"], medios: ["Constancia de asignación de saldo", "Detalle de consumos", "Mecanismo de contratación (paquetes no solicitados)"] },

    // 8. Contratación No Solicitada (materiaId: 8)
    { id: 38, concepto: "Desconoce contratación del servicio principal", materiaId: 8, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Acuerdo para la adquisición o financiamiento de equipos terminales", "Constancia de instalación del servicio", "Mecanismo de contratación"] },
    { id: 39, concepto: "Desconoce contratación del servicio principal", materiaId: 8, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Acuerdo para la adquisición o financiamiento de equipos terminales", "Mecanismo de contratación", "Reporte de verificación biométrica de huella dactilar"] },
    { id: 54, concepto: "Desconocimiento de servicios adicionales o suplementarios", materiaId: 8, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Mecanismo de contratación"] },
    { id: 55, concepto: "Desconocimiento de servicios adicionales o suplementarios", materiaId: 8, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Mecanismo de contratación", "Reporte de verificación biométrica de huella dactilar"] },
    { id: 56, concepto: "Desconoce adquisición de paquetes de tráfico o señales de programación", materiaId: 8, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Mecanismo de contratación"] },
    { id: 57, concepto: "Desconoce adquisición de paquetes de tráfico o señales de programación", materiaId: 8, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Mecanismo de contratación", "Reporte de verificación biométrica de huella dactilar"] },
    { id: 58, concepto: "Desconoce contrato de adquisición o financiamiento de equipo terminal cuyo pago es incluido en el recibo como concepto facturable", materiaId: 8, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga"], medios: ["Acuerdo para la adquisición o financiamiento de equipos terminales", "Mecanismo de contratación"] },
    { id: 59, concepto: "Desconoce contrato de adquisición o financiamiento de equipo terminal cuyo pago es incluido en el recibo como concepto facturable", materiaId: 8, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Acuerdo para la adquisición o financiamiento de equipos terminales", "Mecanismo de contratación", "Reporte de verificación biométrica de huella dactilar"] },

    // 9. Migración (materiaId: 9)
    { id: 40, concepto: "Condicionamiento, negativa o falta de respuesta de la solicitud de migración", materiaId: 9, servicios: ["Todos los servicios"], medios: ["Constancia de haber presentado una solicitud determinada", "Constancia donde se informa la imposibilidad de realizar la migración del servicio", "Histórico de pedidos", "Historial de comunicaciones o atenciones", "Recibo"] },
    { id: 60, concepto: "Falta de ejecución de la migración dentro del plazo establecido", materiaId: 9, servicios: ["Todos los servicios"], medios: ["Constancia de haber presentado una solicitud determinada", "Constancia donde se informa la imposibilidad de realizar la migración del servicio", "Histórico de pedidos", "Historial de comunicaciones o atenciones", "Recibo"] },
    { id: 61, concepto: "Facturación corresponde al plan anterior", materiaId: 9, servicios: ["Todos los servicios"], medios: ["Mecanismo de contratación (solicitud de migración)", "Recibo", "Histórico de pedidos"] },
    { id: 41, concepto: "Migración no solicitada", materiaId: 9, servicios: ["Todos los servicios"], medios: ["Mecanismo de contratación (solicitud de migración)", "Recibo"] },

    // 10. Portabilidad (materiaId: 10)
    { id: 42, concepto: "Negativa a recibir la solicitud de portabilidad", materiaId: 10, servicios: ["Telefonía Fija", "Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Historial de comunicaciones o atenciones"] },
    { id: 43, concepto: "Falta de entrega de información sobre portabilidad", materiaId: 10, servicios: ["Telefonía Fija", "Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Solicitud de portabilidad"] },
    { id: 44, concepto: "Falta de consentimiento del abonado para efectuar la portabilidad", materiaId: 10, servicios: ["Telefonía Fija"], medios: ["Mecanismo de contratación", "Solicitud de portabilidad"] },
    { id: 45, concepto: "Falta de consentimiento del abonado para efectuar la portabilidad", materiaId: 10, servicios: ["Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Constancia de validación de código como confirmación del consentimiento del abonado para realizar la portabilidad o para la cesión de posición contractual", "Mecanismo de contratación", "Reporte de verificación biométrica de huella dactilar", "Solicitud de portabilidad"] },
    { id: 46, concepto: "Falta de cobertura", materiaId: 10, servicios: ["Telefonía Fija", "Servicio Móvil Prepago", "Servicio Móvil Postpago"], medios: ["Mecanismo de contratación", "Reporte de publicación de información de cobertura"] },
    { id: 62, concepto: "Falta de retorno del número telefónico", materiaId: 10, servicios: ["Todos los servicios"], medios: ["Solicitud de portabilidad", "Historial de comunicaciones o atenciones"] },

    // 11. Otras Materias Reclamables (materiaId: 11)
    ...
    { id: 48, concepto: "Falta de entrega de recibos", materiaId: 11, servicios: ["Telefonía Fija", "Internet de Acceso Fijo", "Televisión de Paga", "Servicio Móvil Postpago", "Internet Móvil"], medios: ["Acuse de recepción del recibo enviado vía electrónica", "Constancia de entrega del recibo de manera física", "Recibo"] },
